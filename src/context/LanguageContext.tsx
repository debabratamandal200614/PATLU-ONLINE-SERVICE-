...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'hero.subtitle': 'Visit our shop counter in Balasundar (Bhowmik Para), Cooch Behar for SSC, Railway, Banking, Police, Aadhaar Correction, PAN Card, Voter ID, Ayushman Card & PVC Plastic Smart Cards with 100% accuracy and instant receipt.',
  ...
  bn: {
    ...
    'hero.subtitle': 'বালাসুনন্দর (ভৌমিক পাড়া), কোচবিহারে আমাদের দোকানে আসুন এসএসসি, রেলওয়ে, ব্যাঙ্কিং, পুলিশ, আধার সংশোধন, প্যান কার্ড, ভোটার আইডি, আয়ুষ্মান কার্ড এবং পিভিসি প্লাস্টিক স্মার্ট কার্ডের নির্ভুল আবেদন ও তাৎক্ষণিক রসিদ পেতে।',
